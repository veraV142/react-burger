        ...
        <header className={styles.header_line}>
          <div className={styles.header}>
            <div className={`${styles.icon_and_text}`}>
              <MenuLabel text="Конструктор" isActive={true} link="/"> 
                <BurgerIcon type="primary"/>
              </MenuLabel>
              <MenuLabel text="Лента заказов" isActive={false} link="/ribbon"> 
            ...
            <div className={`${styles.icon_and_text}`}>
              <MenuLabel text="Личный кабинет"  isActive={false} link="/profile"> 
